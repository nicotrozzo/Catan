...
typedef enum netwControllerTypes { GENERIC_NETW_CONTROLLER,CTRL_CONSTRUCTION, CTRL_DICES,CTRL_BANKTRADE,CTRL_OFFERTRADE, CTRL_ROBBERCARDS, CTRL_ROBBERMOVE, CTRL_YN};
