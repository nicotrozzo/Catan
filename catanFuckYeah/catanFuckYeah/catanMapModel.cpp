...
{
	bool ret = false;
	if( ((vertex == "1CG") && (road == "1GL")) || ((vertex == "3RS") && (road == "3S2")) || ((vertex == "3QR") && ((road == "3RS") || (road == "3SR" ) || (road == "4Q3")) ) || ((vertex == "0BC")&&(road == "1C0")) )
	{
		ret = true;
	}
	else if ( ((vertex == "23S") && ((road == "3S2")||(road == "3SR")) ) || ((vertex == "2LP") && ((road == "2PS"))||(road == "") ) || ((vertex == "2PS") && (road == "3S2")) )
	{
		ret = true;
	}
	else if ( ((vertex == "4HM") && ((road == "4MQ") || (road == "5H4") || (road == "4QM")) ) || ((vertex == "5AD") && ((road == "0A5") || (road == "5DH") || (road == "5HD"))) ) 
	{
		ret = true;
	}
	else if( ((vertex == "5DH") && (road == "5H4")) || ((vertex == "1GL") && (road == "2L1")) || ((vertex == "0AB")&&(road == "0BC")) || ((vertex == "05A")&&(road == "0AB")) || ((vertex == "01C") && (road == "1CG")) )
	{
		ret = true;
	}
	else if ((vertex == "4MQ") && (road == "4Q3"))
	{
		ret = true;
	}
	return ret;
