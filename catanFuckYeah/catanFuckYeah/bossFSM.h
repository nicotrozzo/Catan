...
#define TX(x) (static_cast<void (genericFSM::* )(genericEvent *)>(&bossFSM::x)) //casteo a funcion, por visual
	...
	{ { PLAYING,TX(sendInputEv) },			{ REMATCH,TX(doNothing/*NO VA ESTO*/) }, { START_MENU,TX(closeConnection) },	{ WAITING_TO_QUIT,TX(finishGame) },		  { PLAYING,TX(closeGame) },			  { PLAYING,TX(sendNetwEv) },					{ PLAYING,TX(sendTimerEv) } },				//PLAYING
